...
class GameBoardPanel extends JPanel {
   ...
   */
   public GameBoardPanel(VisibleField visibleField) { 
      ...
      /*
      System.out.println("status: "+this.visibleField.getStatus(2,1));

      for(int i = 0; i< 4; i++){
         for(int j=0; j<  4; j++){
            System.out.print(this.visibleField.getStatus(i, j) + " ");
         }
         System.out.println();
      }
      System.out.println(this.visibleField.getMineField());
      */
      setUpGUI(); 
   ...
   */
   public GameBoardPanel(int numRows, int numCols, int numMines) {
      ...
      /*
      System.out.println("status: "+this.visibleField.getStatus(3,4));
      System.out.println(this.visibleField.getMineField());
      */
